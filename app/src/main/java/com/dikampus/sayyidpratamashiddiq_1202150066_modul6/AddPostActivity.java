package com.dikampus.sayyidpratamashiddiq_1202150066_modul6;

/**
 * Created by SP-SHOCK on 4/1/2018.
 */
...
import com.dikampus.sayyidpratamashiddiq_1202150066_modul6.model.Post;
import com.dikampus.sayyidpratamashiddiq_1202150066_modul6.model.User;
                    ...
                    img.putFile(imgUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            if (task.isSuccessful()){
                                ...
                                Post post = new Post(id, userId, name, download_url, title, postMsg);
